...
LED* kitchen = new LED(212);		// placeholder - Eigenlijk een gloeilamp, maar we hebben 2 leds in opstelling
LED* bathroom = new LED(969);		// placeholder
...
TemperatureSensor* tempBathroom = new TemperatureSensor(51);
TemperatureSensor* tempLivingRoom = new TemperatureSensor(50);
